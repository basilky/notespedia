    ...
    <div class="row remove text-center single">
      <div class="col-12 col-sm-12 col-md-1 flexbox remove">
        ...
        <i
          ...
          style="color:#e57373;"
        ></i>
        <i v-else class="fas fa-question-circle fa-7x icon" style="color:#00897B;"></i>
      </div>
      ...
      <div class="col-md-4 col-12 col-sm-12 flexbox smallpadding">
        ...
        <b style="text-align: center">
          <b>{{ value.subject.replace(/[0-9]/g, '').toUpperCase() + ' > ' + 'Module ' + value.module }}</b>
        </b>
        <br />
        <p style="text-align: center">
          Uploaded by
          <a v-bind:href="getprofileurl(value.user)">{{ value.user}}</a>
        </p>
      </div>
      ...
      <div class="col-md-2 col-6 col-sm-4 flexbox">
        ...
        <div v-if="myRatings.hasOwnProperty(value.id)" style="text-align:center">
          <label style="font-size: 15px; margin-top: 10px;">Your Rating</label>
          <star-rating
            inactive-color="#e1bad9"
            active-color="#cc1166"
            :border-width="3"
        ...
        <div v-else style="width:100%">
          <ratenow :id="value.id" :issignedin="loggedin" :type="1" v-on:rated="rated($event)"></ratenow>
        </div>
      </div>
      <div class="col-md-3 col-12 col-sm-4 flexbox">
        <a
          v-if="value.extension!='zip'"
          v-bind:href="view(value.location,value.subject.replace(/[0-9]/g, ''),value.module,value.extension)"
          target="_blank"
...
export default
  {
    ...
    methods:
    {
      ...
      view: function (id, subject, module, extension)  
      {
        var title = subject.toUpperCase() + "-module" + module + '.' + extension;
