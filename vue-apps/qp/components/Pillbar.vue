    ...
    <div class="row remove filterrow">
      ...
      <div class="col-md-3 flexbox">
        ...
        >
          ...
          <option value="main">University Exam</option>
          <option value="first">First Internal Exam</option>
          <option value="second">Second Internal Exam</option>
