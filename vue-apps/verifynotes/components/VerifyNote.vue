    ...
    >
      ...
      <div class="col-md-6 flexbox smallpadding">
        ...
        <b style="text-align: center">
          <b>{{ value.subject.toUpperCase() + ' > ' + 'Module ' + value.module }}</b>
        </b>
        <br />
...
export default
  {
    ...
    methods:
    {
      ...
      {
        return "//drive.google.com/uc?export=download&id=" + id;//+ id.slice(2);
      },
      ...
      accept: function (id)       
      {
        ...
        fetch(`/backend/acceptfile.php?type=1&id=${id}`).then((resp) => resp.json()).then(function (data)
        {
          if (data != 1)            
          {
      ...
      reject: function (id)       
      {
        ...
        fetch(`/backend/rejectfile.php?type=1&id=${id}`).then((resp) => resp.json()).then(function (data)
        {
          if (data != 1)            
          {
